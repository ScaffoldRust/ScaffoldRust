        ...
        <div className="space-y-12">
          ...
          <div className="space-y-4">
            <div className="flex items-center gap-2 text-sm">
              ...
              <span className="text-muted-foreground">web3-community/templates</span>
            </div>
          ...
          <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
            {template.images.map((image, i) => (
              <div key={i} className="aspect-[16/9] relative overflow-hidden rounded-lg border">
                <Image
          ...
          <div className="space-y-6">
            ...
            <p className="text-muted-foreground">
              Execute <code className="rounded bg-muted px-1.5 py-0.5">create-next-app</code> with npm, yarn, or pnpm to
              bootstrap the example:
            </p>
            <CodeBlock language="bash" code="npx create-next-app --example web3-wallet web3-wallet-app" />
            <p className="text-muted-foreground">Deploy it to the cloud with Vercel (Documentation).</p>
          </div>
        </div>
      </div>
    </div>
